-- Changing datatype for orders_table
...
-- Changing datatype for dim_users table
...
-- Create combined latitude column
...
-- Changing datatype for dim_store_details
ALTER TABLE dim_store_details
...
-- Remove "£" sign from dim_products table
UPDATE dim_products
SET product_price = REPLACE(product_price, '£', ''); 

-- Create weight classes for weight of items
...
-- Change datatype for dim_products table
ALTER TABLE dim_products
...
-- Change dim_products table to BOOL 
UPDATE dim_products
...
-- Change dim_card_details datatype 
